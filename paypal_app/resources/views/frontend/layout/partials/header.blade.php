                        ...
                        <ul class="ht-menu">
                            ...
                            <li>
                                ...
                                <div class="language ht-language">
                                    <ul class="ht-setting-list">
                                        <li class="active"><a href="#"><img src="{{asset('/')}}frontend/asset/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                                        <li><a href="#"><img src="{{asset('/')}}frontend/asset/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="hm-minicart">
                                ...
                                <div class="minicart">
                                    ...
                                    <div class="minicart-button">
                                        ...
                                        <a href="{{route('home.checkout')}}" class="li-button li-button-fullwidth li-button-sm">
                                            <span>Checkout</span>
                                        </a>
                                    </div>
                                </div>
